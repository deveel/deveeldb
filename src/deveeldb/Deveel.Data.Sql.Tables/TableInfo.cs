...
namespace Deveel.Data.Sql.Tables {
	...
	public sealed class TableInfo : IObjectInfo, IEnumerable<ColumnInfo> {
		...
		/// <param name="columnType">The <see cref="SqlType"/> of the column to add.</param>
		/// <returns>
		/// Returns an instance of <see cref="ColumnInfo"/> that is generated by
		/// the given parameters.
		/// </returns>
		/// <seealso cref="AddColumn(string, SqlType, bool)"/>
		public ColumnInfo AddColumn(string columnName, SqlType columnType) {
		...
		public ColumnInfo AddColumn(string columnName, SqlType columnType, bool notNull) {
