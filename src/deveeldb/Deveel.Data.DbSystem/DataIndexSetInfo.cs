...
namespace Deveel.Data.DbSystem {
	...
	public sealed class DataIndexSetInfo : ICloneable, IEnumerable<DataIndexInfo> {
		...
		/// </returns>
		/// <exception cref="IndexOutOfRangeException">If the given <paramref name="i"/>
		...
		/// </returns>
		/// <exception cref="ArgumentNullException">If the given <paramref name="indexName"/>
		...
		/// <returns>
		/// Returns a <see cref="string"/> for the resolved index name.
		/// </returns>
		/// <exception cref="DatabaseException">
