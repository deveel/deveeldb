...
namespace Deveel.Data.Types {
	...
	public sealed class UserType {
		...
		/// by reflecting an external <see cref="Type"/>.
		/// </summary>
		...
		/// <see cref="Type"/> given, having the specified
		/// name.
		/// </summary>
		/// <param name="type">The external <see cref="Type"/> used to
