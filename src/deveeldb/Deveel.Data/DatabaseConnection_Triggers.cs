...
namespace Deveel.Data {
	public sealed partial class DatabaseConnection {
		...
		public void CreateTrigger(string triggerName, string triggerSource, TriggerEventType type) {
			database.TriggerManager.AddTrigger(this, triggerName, type, triggerSource, FireTrigger);
		}
		...
		public void DeleteTrigger(string triggerName) {
			database.TriggerManager.RemoveTrigger(this, triggerName);
		}
		...
		public void OnTriggerEvent(TriggerEventArgs evt) {
		...
		private void FireTrigger(object sender, TriggerEventArgs args) {
			try {
				...
				if (call_back != null) {
					lock (triggerEventBuffer) {
						...
						if (transaction == null) {
							call_back.TriggerNotify(args.TriggerName, args.Type, args.Source, args.Count);
						} else {
