...
namespace Deveel.Data.DbSystem {
	public static class DatabaseProperties {
		...
		public const string DefaultSchemaKeyName = "database.defaultSchema";
		...
		//public static readonly ConfigKey DefaultSchema = new ConfigKey(DefaultSchemaKeyName, "APP", typeof(string));
