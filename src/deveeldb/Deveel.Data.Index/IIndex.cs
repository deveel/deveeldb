...
namespace Deveel.Data.Index {
	...
	/// </para>
	/// </remarks>
	public interface IIndex : IEnumerable<int> {
		/// <summary>
		...
		/// returns <b>false</b>.
		/// </returns>
		bool UniqueInsertSort(int value);
		...
		/// not change).
		/// </remarks>
		void InsertSort(object key, int value, IIndexComparer comparer);
		...
		/// </returns>
		int RemoveSort(object key, int value, IIndexComparer comparer);
