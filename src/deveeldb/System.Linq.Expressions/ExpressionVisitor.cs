...
namespace System.Linq.Expressions {
	public abstract class ExpressionVisitor {
		...
		protected BinaryExpression UpdateBinary(BinaryExpression b, Expression left, Expression right, Expression conversion,
			bool isLiftedToNull, MethodInfo method) {
