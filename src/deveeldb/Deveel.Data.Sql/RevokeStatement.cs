...
namespace Deveel.Data.Sql {
	[Serializable]
	public sealed class RevokeStatement : PrivilegesStatement {
		public RevokeStatement(Privileges privileges, GrantObject grantObject, string grantName, IList users, bool grantOption)
			: base(privileges, grantObject, grantName, users, grantOption) {
		}

		public RevokeStatement(Privileges privileges, GrantObject grantObject, string grantName, IList users)
			: this(privileges, grantObject, grantName, users, false) {
		}

		public RevokeStatement(Privileges privileges, GrantObject grantObject, string grantName, string user, bool grantOption)
			: this(privileges, grantObject, grantName, UserList(user), grantOption) {
		}

		public RevokeStatement(Privileges privileges, GrantObject grantObject, string grantName, string user)
