...
namespace Deveel.Data.Sql.Statements {
	class StatementSerializerProvider : ObjectSerializerProvider {
		protected override void Init() {
			Register<AlterTableStatement, AlterTableStatement.PreparedSerializer>();
			Register<AlterUserStatement, AlterUserStatement.PreparedSerializer>();
			Register<LoopControlStatement, LoopControlStatement.Serializer>();
			...
			Register<CreateUserStatement, CreateUserStatement.PreparedSerializer>();
			...
			Register<OpenStatement, OpenStatement.PreparedSerializer>();
