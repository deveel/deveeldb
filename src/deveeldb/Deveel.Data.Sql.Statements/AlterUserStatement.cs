...
namespace Deveel.Data.Sql.Statements {
	...
	public sealed class AlterUserStatement : SqlStatement, IPreparable {
		...
		protected override void ExecuteStatement(ExecutionContext context) {
			...
			bool secureAccessPrivs = context.Request.Query.Session.SystemAccess.UserCanManageUsers();
			...
			if (AlterAction.ActionType == AlterUserActionType.SetPassword) {
				...
				context.Request.Query.Session.SystemAccess.AlterUserPassword(UserName, password);
				...
				context.Request.Query.Session.SystemAccess.SetUserGroups(UserName, groupNames);
			} else if (AlterAction.ActionType == AlterUserActionType.SetAccountStatus) {
				context.Request.Query.Session.SystemAccess.SetUserStatus(UserName, ((SetAccountStatusAction)AlterAction).Status);
			}
		}
	}
}
