	...
	static partial class SqlParseUtil {
		public static class Subquery {
			...
			private static SqlQueryExpression Form(IContext context,
				PlSqlParser.SubqueryBasicElementsContext basicElements) {
				SqlParseIntoClause into;
			...
			static class FromClauseBuilder {
				...
				private static FromSource FormSource(IContext context,
					PlSqlParser.QueryExpressionClauseContext clause) {
					var tableName = Name.Object(clause.objectName());
