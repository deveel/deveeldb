...
namespace Deveel.Data.Events {
	...
	/// </para>
	/// </remarks>
	/// <typeparam name="TEvent">The type of <see cref="IEvent"/>
	/// handled by this registry</typeparam>
	public interface IEventRegistry<in TEvent> : IEventRegistry where TEvent : class, IEvent {
		/// <summary>
