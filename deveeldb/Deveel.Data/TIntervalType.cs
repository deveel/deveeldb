...
namespace Deveel.Data {
	public sealed class TIntervalType : TType {
		public TIntervalType(SQLTypes type, int length)
			: base(type) {
			this.length = length;
		}
